...
/**
 ...
 - BarrierAsync:    runs code asynchronously blocking on a given `dispatch_queue_t`.
...
public enum DispatchQueue: CustomStringConvertible, CustomDebugStringConvertible {
    ...
    case BarrierAsync(dispatch_queue_t)
    ...
    public func execute(block: DispatchExecutionBlock) {
        ...
        case .BarrierAsync(let queue): dispatch_barrier_async(queue, block)
    ...
    public var description: String {
        ...
        case .BarrierAsync(let queue): return "DispatchQueue.BarrierAsync, Queue -> \(queue)"
